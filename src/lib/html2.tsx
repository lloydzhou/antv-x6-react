...
export class HTML2View extends NodeView {
  protected init() {
    super.init()
...
NodeView.registry.register('html2-view', HTML2View, true)

export class HTML2Shape extends Shape.HTML {}
...
HTML2Shape.registry.register('html2', HTML2Shape, true)
